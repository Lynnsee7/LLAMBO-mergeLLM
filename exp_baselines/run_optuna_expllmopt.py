...
# ==================================================================
ALL_BO_MODELS  = [{'template_object': RandomTemplate(), 'name_experiment': 'VicunaOptunaLLMOPT (Random init)', 'bo_type': 'optunaexpllmopt'}]
...
if __name__ == '__main__':
    ...
    if run_config in ['bayesmark_clf', 'bayesmark_reg']:
        ...
        from tasks_optuna_exp import run_bayesmark
